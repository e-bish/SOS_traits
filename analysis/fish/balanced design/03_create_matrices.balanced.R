...
load(here("data", "net_tidy.balanced.Rdata")) 
net_tidy <- net_tidy.balanced
...
#completed in the previous script
...
CV(fish_Q.t$mean_length_mm) #better, but not necessary

#the gower's distance function automatically scales traits to give equal weight
