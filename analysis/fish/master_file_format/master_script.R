...
#create a version of the abundance matrix that retains IPAs and a version that sums acrosss IPAs
...
#plot the results
FD_results %>% 
  pivot_longer(!c(site, region, eelgrass, year), names_to = "metric", values_to = "value") %>% 
